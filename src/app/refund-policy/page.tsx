...
export default function RefundPolicy() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 selection:bg-blue-100 pb-20">
      <div className="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 sticky top-0 z-20">
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center">
          <button onClick={() => router.back()} className="flex items-center text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 font-bold transition-colors">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-12">
        <div className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-slate-800 dark:text-slate-100 tracking-tight mb-4">Refund & Cancellation Policy</h1>
          <p className="text-lg text-slate-500 dark:text-slate-400 font-medium">Last updated: July 2026</p>
        </div>
        ...
        <div className="space-y-12">
          <section className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">1. Patient Cancellations</h2>
            </div>
            ...
            <ul className="space-y-3 mt-4 text-slate-600 dark:text-slate-400 font-medium">
              <li className="flex items-start">
                <div className="h-2 w-2 bg-green-500 rounded-full mt-2 mr-3 shrink-0"></div>
                <span><strong>100% Refund:</strong> If you cancel your appointment at least <strong>2 hours</strong> before the scheduled time, you are eligible for a full refund (excluding platform fee).</span>
              </li>
              <li className="flex items-start">
          ...
          <section className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">2. Doctor Cancellations & No-Shows</h2>
            </div>
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium mb-4">
          ...
          <section className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">3. Refund Processing Time</h2>
            </div>
          ...
          <section className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">4. Non-Refundable Services (Platform Fee)</h2>
            </div>
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
              Our platform fee is ₹49. The platform fee will not be refunded if the user cancels or if there is no fault from our side.
            </p>
          </section>
